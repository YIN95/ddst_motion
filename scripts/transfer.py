...
def transfer(opt):
    ...
    fk_out = os.path.join(opt.render_dir, "9_transfer_"+opt.source+"_to_"+opt.target)
    render_out = os.path.join(opt.render_dir, "9_transfer_"+opt.source+"_to_"+opt.target)
    all_score = 0
